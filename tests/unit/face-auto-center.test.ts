...
import { applyDetections, getFaceCenter, getProjectionYawLimit, mapSampleFaceToPanorama, setPanoramaTarget, setViewportTarget, type FaceAutoCenterState, type FaceBox } from '../../src/features/vr/face-auto-center'

const state = (): FaceAutoCenterState => ({
  faces: [], detectionMode: 'viewport', nextDetectionAt: 0, lastDetectionAt: 0,
  consecutiveMisses: 0, isMoving: false, yawVelocity: 0, pitchVelocity: 0, lastErrorAt: 0,
})
