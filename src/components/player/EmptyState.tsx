...
export function EmptyState(props: { onChooseFiles: () => void; onChooseFolder: () => void }) {
  return (
    <section class="absolute inset-0 z-10 box-border grid h-full w-full place-items-center bg-black px-6 text-center text-white">
      <span class="grid -translate-y-[17dvh] justify-items-center gap-6">
        <img src="/icon.svg" alt="Foursmith VR" class="h-24 w-24 drop-shadow-[0_18px_44px_rgba(0,0,0,0.5)] sm:h-32 sm:w-32" />
