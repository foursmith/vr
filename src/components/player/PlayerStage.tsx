export function PlayerStage(props: {
  ...
  setFpsMeter: (element: HTMLDivElement) => void
  setSampleCanvas: (element: HTMLCanvasElement) => void
  setFaceHint: (element: HTMLDivElement) => void
